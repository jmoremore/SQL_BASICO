...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."CANTICOS" 
   (	"CANTICOS_ID" NUMBER, 
	"NOMBRE_CANTICOS" VARCHAR2(20 BYTE), 
	"AFICION_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."CANTICOS"."CANTICOS_ID" IS 'ID DEL CANTICO';
   COMMENT ON COLUMN "HR"."CANTICOS"."NOMBRE_CANTICOS" IS 'NOMBRE DEL CANTICO';
   COMMENT ON COLUMN "HR"."CANTICOS"."AFICION_ID" IS 'ID AFICION';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."EQUIPO"."EQUIPO_ID" IS 'id del equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."NOMBRE_EQUIPO" IS 'nombre del equipo';
   COMMENT ON COLUMN "HR"."EQUIPO"."AFICION_ID" IS 'ID DE LA AFICION';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."ESTADIO"."ESTADIO_ID" IS 'ID DEL ESTADIO';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE TABLE "HR"."JUGADORES" 
   (	"JUGADORES_ID" NUMBER, 
	"NOMBRE_JUGADOR" VARCHAR2(50 BYTE), 
	"EQUIPO_ID" NUMBER
   ) SEGMENT CREATION IMMEDIATE 
  PCTFREE 10 PCTUSED 40 INITRANS 1 MAXTRANS 255 NOCOMPRESS LOGGING
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "HR"."JUGADORES"."JUGADORES_ID" IS 'ID DEL JUGADOR';
   COMMENT ON COLUMN "HR"."JUGADORES"."NOMBRE_JUGADOR" IS 'NOMBRE DEL JUGADOR
';
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into HR.AFICION (AFICION_ID,NOMBRE_GUERRA,EQUIPO_ID) values ('1','Pepineros','1');
REM INSERTING into HR.CANTICOS
SET DEFINE OFF;
Insert into HR.CANTICOS (CANTICOS_ID,NOMBRE_CANTICOS,AFICION_ID) values ('1','Vamos Lega','1');
Insert into HR.CANTICOS (CANTICOS_ID,NOMBRE_CANTICOS,AFICION_ID) values ('2','Aupa Lega','1');
Insert into HR.CANTICOS (CANTICOS_ID,NOMBRE_CANTICOS,AFICION_ID) values ('3','Mierda Geta','1');
...
SET DEFINE OFF;
Insert into HR.EQUIPO (EQUIPO_ID,NOMBRE_EQUIPO,ESTADIO_ID,AFICION_ID) values ('1','LEGANES','1','1');
REM INSERTING into HR.ESTADIO
SET DEFINE OFF;
Insert into HR.ESTADIO (ESTADIO_ID,NOMBRE) values ('1','BUTARQUE');
...
SET DEFINE OFF;
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE_JUGADOR,EQUIPO_ID) values ('1','Serantes','1');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE_JUGADOR,EQUIPO_ID) values ('2','Timor','1');
Insert into HR.JUGADORES (JUGADORES_ID,NOMBRE_JUGADOR,EQUIPO_ID) values ('3','Luciano','1');
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" MODIFY ("AFICION_ID" NOT NULL ENABLE);
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
  ALTER TABLE "HR"."EQUIPO" MODIFY ("NOMBRE_EQUIPO" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."AFICION" ADD CONSTRAINT "EQUIPO_FK2" FOREIGN KEY ("EQUIPO_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "HR"."EQUIPO" ADD CONSTRAINT "AFICION_FK2" FOREIGN KEY ("AFICION_ID")
	  REFERENCES "HR"."AFICION" ("AFICION_ID") ENABLE;
